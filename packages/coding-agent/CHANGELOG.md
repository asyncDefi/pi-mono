...
- Added `/mcp-to-skill`, a built-in interactive command that turns pasted or file-backed MCP capabilities into project-local skills under `.pi/skills/` without depending on MCP packages or adapters
